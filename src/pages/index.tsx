        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="hidden md:flex items-center">
              ...
              <Link href="/privacy" className="px-3 py-2 rounded-md text-white font-medium hover:bg-blue-700">
                Privacy Policy
              </Link>
            </div>
        ...
        {showMobileMenu && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <Link href="/privacy" className="block px-3 py-2 rounded-md text-white font-medium hover:bg-blue-700">
                Privacy Policy
              </Link>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-blue-600">Welcome to FunFlags</h1>
            ...
            <div className="flex flex-col items-center justify-center space-y-6">
              <div className="bg-blue-50 p-6 rounded-lg w-full">
                <h2 className="text-xl font-semibold text-blue-800 mb-3">About Our App</h2>
