        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="hidden md:flex items-center">
              ...
              <Link href="/privacy" className="px-3 py-2 rounded-md text-white font-medium bg-green-700">
                Privacy Policy
              </Link>
            </div>
        ...
        {showMobileMenu && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <Link href="/privacy" className="block px-3 py-2 rounded-md text-white font-medium bg-green-700">
                Privacy Policy
              </Link>
            </div>
          </div>
      ...
      <main className="flex-grow">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="bg-white p-8 rounded-lg shadow-lg">
            <h1 className="text-3xl font-bold text-green-600 mb-6">Privacy Policy for FunFlags</h1>
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-medium text-green-700 mb-2">Information You Provide</h3>
              <p className="text-gray-700 mb-4">
                We do not require you to create an account or provide any personal information to use our app.
              </p>
              
              <h3 className="text-xl font-medium text-green-700 mb-2">Information Collected Automatically</h3>
              ...
              <h3 className="text-xl font-medium text-green-700 mb-2">Third-Party Services</h3>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-green-800 mb-4">Data Storage and Security</h2>
              <ul className="list-disc pl-5 text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-green-800 mb-4">Data Sharing and Disclosure</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-green-800 mb-4">Your Choices</h2>
              <ul className="list-disc pl-5 text-gray-700 mb-4">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                <i>ridhanfadhilah@gmail.com</i>
              </p>
            </section>
            
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-green-800 mb-4">Consent</h2>
              <p className="text-gray-700 mb-4">
